...
export const metadata: Metadata = {
  ...
  description: "Experience 5-star luxury at Grand Haven Hotel. Premium rooms, exceptional amenities, spa services, fine dining, and personalized hospitality in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium rooms, spa services, fine dining, business center, hotel amenities, city center hotel",
  ...
  openGraph: {
    title: "Grand Haven Hotel - Luxury Accommodations & World-Class Service",
    description: "Experience 5-star luxury at Grand Haven Hotel with premium rooms, exceptional amenities, and personalized service.",
    ...
    images: [{
      ...
      alt: "Grand Haven Hotel exterior with beautiful architecture"
    }],
    type: "website"
  },
  twitter: {
